...
window.onload = function () {
    ...
    elements_1.$html.removeClass("js_no");
};
},{"./frontbox/data/browser":4,"./frontbox/data/elements":6,"./frontbox/form/input-counter":7,"./frontbox/information/cookie":8}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var InputCounter = /** @class */ (function () {
    ...
    InputCounter.prototype.refresh = function () {
        ...
        /* Loop elements */
        this.$wrap.each(function (i, element) {
            var $wrap = $(element), $input = $wrap.find(_this.cssClass.input), $button = $wrap.find(_this.cssClass.button);
            _this.$input.append($input);
            _this.$button.append($button);
        });
        this.active = true;
    };
    return InputCounter;
