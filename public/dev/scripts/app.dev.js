...
var InformationCookie = /** @class */ (function () {
    function InformationCookie() {
        ...
        this.show = function () { return __awaiter(_this, void 0, void 0, function () {
            var cookiesContent, cookiesContentHTML;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('cookies.html', {
                            headers: {
                                'Content-Type': 'text/html'
                            },
                        })];
                    case 1:
                        cookiesContent = _a.sent();
                        return [4 /*yield*/, cookiesContent.text()];
                    case 2:
                        cookiesContentHTML = _a.sent();
