...
},{"css-vars-ponyfill":1,"vh-check":3}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var FrontboxConsole = /** @class */ (function () {
    function FrontboxConsole(param) {
        ...
        this.label.addEventListener('click', function (e) {
            if (!_this.autoOpen) {
                _this.unreadCount = 0;
                _this.updateUnreadCounter('');
            }
            _this.open = !_this.open;
            _this.toggle(e);
        });
    }
    FrontboxConsole.prototype.toggle = function (e) {
        this.element.classList.toggle('open');
        return;
    };
    FrontboxConsole.prototype.updateUnreadCounter = function (value) {
