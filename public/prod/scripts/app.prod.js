...
(function () {
    ...
    (function (global, factory) {
      ...
      jQuery.fn.extend({
        ...
        serializeArray: function serializeArray() {
          ...
          var _a3 = _r4.filter(function () {
            var type = this.type; // Use .is( ":disabled" ) so that fieldset[disabled] works

            return this.name && !jQuery(this).is(":disabled") && rsubmittable.test(this.nodeName) && !rsubmitterTypes.test(type) && (this.checked || !rcheckableType.test(type));
          });

          var _f3 = function _f3(i, elem) {
  ...
  3: [function (require, module, exports) {
    ...
    "./frontbox/data/browser": 4,
    "./frontbox/data/elements": 6,
    "./frontbox/form/input-counter": 7,
    "./frontbox/information/cookie": 8
  }],
  4: [function (require, module, exports) {
    ...
    function () {
      ...
      Browser.prototype.refresh = function () {
        /* Prepare variables */
        var width = elements_1.$window.outerWidth(),
            lastWidth = this.width,
            height = elements_1.$window.outerHeight(),
    ...
    function () {
      ...
      InputCounter.prototype.refresh = function () {
        ...
        this.$wrap.each(function (i, element) {
          var $wrap = $(element),
              $input = $wrap.find(_this.cssClass.input),
              $button = $wrap.find(_this.cssClass.button);
          console.log($input);
          console.log($button);
